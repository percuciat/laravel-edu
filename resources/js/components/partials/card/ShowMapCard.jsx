...
const ShowMapCard = ({elemId}) => {
    const {openMap} = useContext(MyContext);
    return <>
        <div className="head head-address" onClick={() => openMap(elemId)}>
...
ShowMapCard.propTypes = {};
ShowMapCard.defaultProps = {};
